...
export const STRUCTURES = [
  {
    ...
    beats: [
      ...
      { id: "plot-point-1", name: "First Plot Point",   pct: 8,  act: "setup",  guide: "The point of no return — the protagonist commits to the journey.", ex: "Hero grabs sword" },
      { id: "rising",       name: "Rising Action",      pct: 20, act: "rise",   guide: "Obstacles escalate, stakes climb, the protagonist learns the rules of the new world.", ex: "Gathers allies, trains" },
      { id: "midpoint",     name: "Midpoint",           pct: 8,  act: "rise",   guide: "A false victory or false defeat that shifts the story's direction and raises the stakes.", ex: "Discovers dragon's weakness" },
      ...
      { id: "climax",       name: "Climax",             pct: 15, act: "climax", guide: "The final confrontation. The protagonist's central struggle is decided here.", ex: "Duels dragon alone" },
